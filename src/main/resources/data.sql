 ...
 */
-- TODO> coloquei o adm e os funcionarios com vacinacao finalizada pq tava dando nullpointer toda hora q interava sobre o set de cidadao procurando as situacoes
-- TODO> ou seja, todos os cidadãos cadastrados (mesmo o adminstrador), têm que ter um cartão vacinação para nao dar nullpointer (ou toda vez que interar tem que lembrar de tira-lo)
INSERT INTO cartao_vacina(cartao_sus, situacao) VALUES ('000000000000000','VACINACAOFINALIZADA');
INSERT INTO cidadao (email,cpf,nome,senha,cartao_vacina_cartao_sus) VALUES ('admin@admin','00000000000','Administrador','admin','000000000000000');
...
INSERT INTO cidadao(cpf, cartao_sus, data_nascimento, email, endereco, nome, senha, telefone, cartao_vacina_cartao_sus)
VALUES('12345670015','154789653256006',date'1980-11-22','froidcantor@gmail.com','Av do Matheus, 410', 'Froid Renato','froid','(79)3523-5342','154789653256006');
...
UPDATE cartao_vacina SET data_primeira_dose = timestamp'2021-03-01', data_segunda_dose = timestamp'2021-03-29',situacao = 'TOMOU2DOSE',vacina_nome_fabricante = 'Moderna' WHERE cartao_sus = '154789653256005';

-- Adicionando alguns requisitos
INSERT INTO requisito_comorbidade VALUES ('Pressão Alta',70,true,true);
INSERT INTO requisito_profissao VALUES ('Estutande de Medicina da Unit', 22,true,false);